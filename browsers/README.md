...
* Windows direct download from powershell, for setting up a new Windows install without running Edge:
    * `iwr -uri` [https://download.mozilla.org/?product=firefox-latest-ssl&os=win64&lang=en-US](https://download.mozilla.org/?product=firefox-latest-ssl&os=win64&lang=en-US)
